...
class Migration(migrations.Migration):
    replaces = [
        ("frontend", "0017_emailmessage_maillog_squashed_0021_auto_20170301_1627"),
        ("frontend", "0018_auto_20170302_1533"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                (
                    "message_id",
                    models.CharField(max_length=998, primary_key=True, serialize=False),
                ),
                ...
                (
                    "to",
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.CharField(db_index=True, max_length=254),
                        size=None,
                    ),
                ),
            ],
