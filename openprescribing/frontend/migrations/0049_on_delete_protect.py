...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="vmpp",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.PROTECT, to="dmd.VMPP"
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name="practice",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="frontend.Practice"
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="dmd.DtPaymentCategory"
            ),
        ),
        migrations.AlterField(
            model_name="tariffprice",
            name="vmpp",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="dmd.VMPP"
            ),
        ),
    ]
